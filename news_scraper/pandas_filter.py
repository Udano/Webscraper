...
#Count the keywords in a list and convert the series into a pandas dataframe including count
...
#Calls the filter and count keyword functions and returns the result
...
#testing the funtions for development purposes
